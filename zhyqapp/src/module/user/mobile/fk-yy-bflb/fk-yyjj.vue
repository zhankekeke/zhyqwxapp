    ...
    <div class="container" ref="aa">
        ...
        <div class="wrap2">
                <ul class="mul">
                    ...
                    <li >
                        <span>姓名:&nbsp;&nbsp; {{$_intinfo_$.visitorName}}</span>
                    </li>
                    <li style="border-top: 1px solid #f4f4f4">
                        <span >电话:&nbsp;&nbsp; {{$_intinfo_$.visitorMobile}}</span>
                    </li>
                    <li style="border-top: 1px solid #f4f4f4">
                        <span>单位:&nbsp;&nbsp; {{$_intinfo_$.visitorCompany}}</span>
                    </li>
                    ...
                    <li style="border-top: 1px solid #f4f4f4">
                     ...
                     <li class="last">
                        <h2 >反馈信息</h2>
                         <div class="reason">
                        <span v-if="$_intinfo_$.auditStatus == 0">状态：等待回应</span>
                        <span v-if="$_intinfo_$.auditStatus == 1">状态：已通过</span>
                        <span style="color:#FA541C;" v-if="$_intinfo_$.auditStatus == 2">状态：已拒绝</span>
